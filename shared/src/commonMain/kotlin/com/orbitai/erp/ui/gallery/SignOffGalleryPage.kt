...
private val SignOffEntries = listOf(
    ...
    SignOffEntry(SignOffStatus.Covered, "OrbitDonut / Segmented / Pill / Stage / Step", "Progress gallery"),
    ...
    SignOffEntry(SignOffStatus.Covered, "OrbitMessageField / Voice / AudioWave", "Composer gallery"),
    ...
    SignOffEntry(SignOffStatus.Covered, "OrbitMultiSelectField (raw)", "Input gallery · beside managed materials"),
    SignOffEntry(SignOffStatus.Covered, "Skeleton / Confirm / Rename / Create / Dialog", "State gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitInfoPopover / OrbitBubblePopover", "Overlay gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitCopyButton", "Overlay gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitFileUpload / Attachments", "Display gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitDialog base", "State gallery · custom shell"),
    SignOffEntry(SignOffStatus.Covered, "OrbitCreateDialog", "State gallery · Add stage"),
    SignOffEntry(SignOffStatus.Covered, "OrbitScrollbar (V/H)", "Scrollbar gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitLazyScrollbar", "Scrollbar gallery · lazy"),
    SignOffEntry(SignOffStatus.Covered, "OrbitLoadingIcon", "Feedback gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitSwitch", "Feedback gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitPillProgress", "Progress gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitTopAppBar", "Shell gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitListRow", "Shell gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitEmptyState", "Shell gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitSnackbar / Host", "Shell gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitBottomSheet", "Shell gallery"),
    SignOffEntry(SignOffStatus.Covered, "Brand marks (launcher / opening / nav)", "Brand gallery"),
    SignOffEntry(SignOffStatus.Covered, "OrbitSplashScreen", "Brand gallery · replay"),
    SignOffEntry(SignOffStatus.Covered, "OrbitCard / Divider / Count / Presence", "Display gallery"),
    SignOffEntry(
        SignOffStatus.Partial,
        "KPI tiles / role cards",
        "Deferred until role screens — out of this library pass",
    ),
)
