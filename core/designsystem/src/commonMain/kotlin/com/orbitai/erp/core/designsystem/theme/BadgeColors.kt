...
internal val OrbitLightBadgeColors: Map<OrbitBadgeTone, OrbitBadgeColors> = mapOf(
    ...
    OrbitBadgeTone.Blue to OrbitBadgeColors(
        // Soft primary-container glass: #B3DBF5 fill, #004A77 ink (Material-style pair).
        container = Color(0x42B3DBF5),
        border = Color(0x8C004A77),
        label = Color(0xFF004A77),
        // One step darker than the label so icon != label (BadgeContrastTest) while staying in-family.
        icon = Color(0xFF003F66),
        solidContainer = Color(0xFF004A77),
        onSolidContainer = Color(0xFFFFFFFF),
    ),
...
internal val OrbitDarkBadgeColors: Map<OrbitBadgeTone, OrbitBadgeColors> = mapOf(
    ...
    OrbitBadgeTone.Blue to OrbitBadgeColors(
        // Soft primary-container glass: #105682 fill, #C2E7FF ink.
        container = Color(0x57105682),
        border = Color(0xA6C2E7FF),
        label = Color(0xFFC2E7FF),
        // One step lighter than the label so icon != label while staying in-family.
        icon = Color(0xFFD0ECFF),
        solidContainer = Color(0xFFC2E7FF),
        onSolidContainer = Color(0xFF121212),
    ),
    OrbitBadgeTone.Indigo to OrbitBadgeColors(
    ...
    OrbitBadgeTone.Red to OrbitBadgeColors(
        // Lifted from 0x57731511 for charcoal dark card (#1C1C1E) delta/badge body.
